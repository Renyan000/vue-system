  ...
  <div class="home">
    <el-row style="padding: 0 20px">
      <el-col :span="24" style="text-align: right">
        <el-button type="primary" id="btn1" size="small" @click="addMenuBtn" v-if="btnArr.indexOf('btn1')>=0">添加</el-button>
      </el-col>
    </el-row>
    <el-row style="padding: 0 20px">
      <el-scrollbar style="height: 100%">
        <el-table :data="menuList" style="width: 100%" :row-class-name="isFatherColor" v-loading="loadingIcon">
          <el-table-column prop="name" label="单位名称" width=""></el-table-column>
          <el-table-column fixed="right" label="操作" width="200">
            <template slot-scope="scope">
              <el-button size="mini" id="btn2" @click="editMenu(scope.row)" v-if="btnArr.indexOf('btn2')>=0">修改</el-button>
              <el-button size="mini" id="btn3" @click="deleteMenu(scope.row)" type="danger" v-if="btnArr.indexOf('btn3')>=0">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-scrollbar>
